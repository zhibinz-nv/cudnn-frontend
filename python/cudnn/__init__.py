...
_LAZY_OPTIONAL_IMPORTS = {
    ...
    "MoeEp": (".moe_ep", "MoeEp"),
    "MoeEpBufferLifetime": (".moe_ep", "MoeEpBufferLifetime"),
    "MoeEpExecutionLane": (".moe_ep", "MoeEpExecutionLane"),
    "MoeEpForwardContextBuffers": (".moe_ep", "MoeEpForwardContextBuffers"),
    "MoeEpTrainingBufferSpec": (".moe_ep", "MoeEpTrainingBufferSpec"),
    "MoeEpTrainingBufferSpecs": (".moe_ep", "MoeEpTrainingBufferSpecs"),
    "MoeEpTrainingContext": (".moe_ep", "MoeEpTrainingContext"),
    "MoeEpTrainingPlan": (".moe_ep", "MoeEpTrainingPlan"),
    "MoeEpTrainingWeights": (".moe_ep", "MoeEpTrainingWeights"),
    "MoeEpTrainingWgradOperands": (
        ".moe_ep",
        "MoeEpTrainingWgradOperands",
    ),
    "MoeEpWgradGradientBuffers": (".moe_ep", "MoeEpWgradGradientBuffers"),
